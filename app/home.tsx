...
const s = StyleSheet.create({
    ...
    semBadge: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.18)', overflow: 'hidden', backgroundColor: 'rgba(255,255,255,0.08)' },
    semBadgeText: { color: '#fff', fontWeight: '600', fontSize: 12, letterSpacing: -0.1 },
    ...
    cardHeading: { fontSize: 17, fontWeight: '600', color: '#fff', letterSpacing: -0.4 },
